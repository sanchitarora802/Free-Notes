  ...
  return (
    <>
      <div className={`container text-${props.textheadingcolor}`}>
        <h1>
          <center>Welecome to Free-Notes</center>
        </h1>
      </div>
      ...
      <div className="row my-5">
        <div className="col-md-3 photodiv offset-md-1">
          <img
            ...
            className="photocss"
            alt="not avilable"
            style={{ width: "100%", height: "100%", border: "solid 2px black" }}
          />
        </div>
        ...
        <div className="col-md-3 offset-md-1 photodiv">
          <img
            src={edit}
            alt="not avilable"
            style={{ width: "80%", height: "100%", border: "solid 2px black" }}
          />
        </div>
      ...
      <div className="row">
        ...
        <div
          className={`text-${props.textheadingcolor} col-md-3 offset-md-1 my-3`}
        >
